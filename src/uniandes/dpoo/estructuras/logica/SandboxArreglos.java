...
public class SandboxArreglos
{
    ...
    public int[] getCopiaEnteros() {
        ...
        {
            CopiaEnteros[contador] = elemento;
            contador += 1;
        }
        return CopiaEnteros;
    }
    ...
    public void agregarEntero(int entero) {
        ...
        int[] NuevosEnteros = new int[arregloEnteros.length + 1];
        
    
        for (int i = 0; i < arregloEnteros.length; i++) {
        	NuevosEnteros[i] = arregloEnteros[i];
        }  
        NuevosEnteros[arregloEnteros.length] = entero;
    ...
    {
    	 String[] NuevasCadenas = new String[arregloCadenas.length + 1];
         int contador = 0;
         for (String caracter : arregloCadenas) {
        	 NuevasCadenas[contador] = caracter;
             contador += 1;
         }
         NuevasCadenas[arregloCadenas.length] = cadena;
         arregloCadenas = NuevasCadenas;
    }
    ...
    public void insertarEntero(int entero, int posicion) {
        int[] Enteros_nuevos = new int[arregloEnteros.length + 1];
        if (posicion < 0) {posicion = 0;} else if (posicion > arregloEnteros.length) {posicion = arregloEnteros.length;}

        for (int i = 0, j = 0; i < Enteros_nuevos.length; i++) {
            if (i == posicion) {
            	Enteros_nuevos[i] = entero; 
            } else {
            	Enteros_nuevos[i] = arregloEnteros[j]; 
                j++;
            }
        }
        
        arregloEnteros = Enteros_nuevos;
    }
    ...
    public void eliminarEnteroPorPosicion(int posicion) {
        ...
        for (int i = 0, j = 0; i < arregloEnteros.length;) {
            if (i != posicion) {
